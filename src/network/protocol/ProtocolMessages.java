 ...
 * PROTOCOL GROUP A
 *
 * This is the standard network.protocol for Group A. Please, keep up to date with changes made
...
public class ProtocolMessages {
    ...
    /** Dimensions of a board supported by this network.protocol. */
    public static final int[] BOARD_DIMENSIONS = {15, 15};

    /** Command Separator: Used to separate values of a command sent to the network.server. */
    ...
    //-----------------Joining A Server-----------------//
    /** The first message sent by the network.client or network.server to initialize or approve a connection */
    public static final String HELLO = "HI";

    /** Broadcast by the network.server to all clients, so they are aware of a new connection */
    public static final String WELCOME = "W";
    //--------------------------------------------------//

    //-----------------Starting A Game------------------//
    /** The message sent by the network.server to all clients to indicate that it is ready to start.
    ...
    /**	The message is sent by each network.client when they are ready. After sending this, they
    ...
    /**	This command is sent by the network.server to assign tiles to a connected network.client. */
     ...
     * 	-> The move will then have to be validated by the network.server
     * 	-> This message is then broadcasted by the network.server to all
    ...
    /** This command is sent by the network.client to indicate they would like to pass their turn, and if they want to swap any tiles. */
    public static final String PASS = "PASS";

    /** This message is broadcast by the network.server to let all clients know that the game is over and to announce who the winner is. */
    public static final String GAMEOVER = "GO";
    //--------------------------------------------------//

    //----------------Chat Functionality----------------//
    /** A message is sent by a network.client to the network.server using this command. */
    public static final String MSGSEND = "MSGOUT";

    /** A message is broadcasted by the network.server to all clients using this command. */
    public static final String MSGRECEIVED = "MSGIN";
    //--------------------------------------------------//

    //----------------------Errors----------------------//
    /** When a player causes an error to occur in the network.server, this command is used. */
    ...
    //Please check the network.protocol descriptor for specifications on every error, and when it should occur
